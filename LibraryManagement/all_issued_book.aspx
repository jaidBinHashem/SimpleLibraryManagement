<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="all_issued_book.aspx.cs" Inherits="LibraryManagement.all_issued_book" %>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="592px">
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="BookId" HeaderText="Return" DataNavigateUrlFormatString="~/return_booked_confirm.aspx?BookId={0}" DataTextField="BookId" />
            </Columns>
        </asp:GridView>
    </div>
    </form>
